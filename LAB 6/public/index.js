$(document).ready(() => {
    ...
    function generateListElement() {
        list.after(`<div class='input-group mx-auto mb-2 w-50 py-2 mb-2' id='list-item-${counter}'><input type='text' class='form-control' value='${inputTask.val() }' id="list-input-${counter}" readonly><button class='input-group-text' id='list-btn-${counter}'>Claim</button></div>`);
